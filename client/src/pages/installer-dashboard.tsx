      ...
      <div className="p-4 sm:p-6 border-b border-slate-200 bg-gradient-to-r from-emerald-500 via-teal-500 to-blue-500">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-xl px-4 py-2">
              <div className="text-white text-lg font-bold">€{requests.reduce((sum, r) => sum + (Number(r.leadFee) || 0), 0)}</div>
              <div className="text-emerald-100 text-xs">Total Lead Fees</div>
            </div>
          </div>
        </div>
                      ...
                      {selectedRequest ? (
                        ...
                        <div className="space-y-4">
                          <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                            ...
                            <p className="text-sm text-gray-600 mt-1">Click the lead again on the map to see all leads</p>
                          </div>
                          <RequestCard
                            request={selectedRequest}
                            onAccept={handleAcceptRequest}
